\begin{abstract}
An abstract should summarize the work in brief. Now follows some text that you can remove by writing the sign "\%" in front of the command "", you can always comment out text you have written using the "\%" command.
\blindtext
