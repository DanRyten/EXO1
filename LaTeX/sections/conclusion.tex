...
The latency saw definite improvement from the previous work. During testing of the exoskeleton made by the last group
...
Once the arm moves, two main directions could be considered. The first direction is to mount it on a person. After implementing and mounting it the second direction would be to
