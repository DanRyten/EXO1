...
These questions would be accomplished by using additional sensors allowing for a more nuanced analysis of the muscles signal, 
a different choice of AI method which would allow for wider context to be taken into account as well as updated hardware and a different
choice of programming language that would help improve the speed of the system. Using these implementations a system capable of a more varied
classification and faster decision making could be made.

\subsection{Limitations}
This project was subject to several constraints. 
%The overarching one was the limited time of the project, this being 8 weeks,
%which was exasperated by the need to procure sensors, DAQ systems and applicable software. This factor mainly delayed the data acquisition.
